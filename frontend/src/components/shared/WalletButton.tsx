...
export function WalletButton() {
    ...
    return (
      <div className="relative">
        <button
          ...
          className="bg-[#A3E635] text-black px-4 py-1.5 rounded-full text-[13px] font-bold hover:opacity-90 transition-opacity"
        >
  ...
  return (
    <button
      ...
      className="bg-[#A3E635] text-black px-4 py-1.5 rounded-full text-[13px] font-bold hover:opacity-90 transition-opacity disabled:opacity-50"
    >
