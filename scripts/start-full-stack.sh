...
# 使用 Anvil 默认账户私钥
DEPLOYER_KEY="${DEPLOYER_KEY:-$(anvil_default_key_0)}"  # Set DEPLOYER_KEY env var or use Anvil default
...
MATCHER_KEY="${MATCHER_KEY:-$(anvil_default_key_1)}"  # Set MATCHER_KEY env var or use Anvil default
...
echo "    Private Key: (see Anvil output)"
